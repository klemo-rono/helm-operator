...
const (
	...
	// Succeeded means the installation or upgrade of the HelmRelease
	// succeeded.
	HelmReleasePhaseSucceeded HelmReleasePhase = "Succeeded"
	// Failed means the installation or upgrade of the HelmRelease
	// failed.
	...
	// RolledBackFailed means the rollback of the HelmRelease failed.
